...
export default function Final() {
  ...
  return (
    <div className="stack">
      <div className="final-hero"><Trophy size={18} /><div><div className="auth-eyebrow">GPF Open · {d.config.year}</div><h2 className="page-h tight">Final standings</h2></div></div>
